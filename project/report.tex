...
\item[Evaluation] An evaluation of the six classifiers, using several feature modeling techniques, and one combination of two classifiers, on DJ performance and WSJ articles from 2007.
\end{description}
...
Figure~\ref{fig:hmm-nb-experiment} compares the performance of our hybrid HMM+NB model with with: the pick-most-common baseline, Naive Bayes with a sample prior (ratio of each word occurring in previous days), the vanilla HMM, and Naive Bayes with a uniform prior $\pi=(0.5, 0.5)$.
