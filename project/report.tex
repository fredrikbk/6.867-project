...
\caption{Dow Jones movement from January 1 to December 31 2007. The Y axis shows cumulative movement since January 1. We make the simplifying assumption that the Dow Jones moves a unit distance up or down on any day, which makes this a graph of Dow Jones performance in 2007.}
...
The first question we wish to answer is whether we can find correlations between words in the Wall Street Journal and the Dow Jones, and use these correlations to make correctly classify days ``up days'' or ``down days.'' If such a correlation exists, then there are three explanations: the Wall Street Journal influences the stock market prices, the stock market prices influence the Wall Street Journal, or some external ``state of the world'' influences both. While the last possibility is probably most relevant to predicting prices, we also wish to know if we can uncover a correlation which we have reason to believe exists: the correlation between the articles on day $d$ and the closing price on day $d-1$. 

\TODO{Say we can use NB with other models because it is probabilistic, and adaboost builds on decision stumps which build on decision trees and tell us something about our data}

\begin{table}[h]
\centering
\begin{tabular}{|l|}
NB 12 fold cv average:
yesterday 51.46
today 52.71
today-aug 51.46
tomorrow 51.98
...
\begin{itemize}
\item The word ``ambitions'' is the best indicator of the Dow Jones gaining on the same day. If ``ambitions'' appeared in the WSJ there was a 64.26\% chance that the Dow Jones went up on that day.
...
\item The word ``jarring'' in tomorrow's news predicts that today goes up correctly 63.59\% of the time. This is interesting, because that word could be used to refer to the market performance on the previous day. In at least one case, it is used to refer to the ``jarring reversal of recent market trends,'' which is a good feature to pick up on.

\item The phrase ``reserve chairman ben'' in yesterda's news predicts that today goes down correctly 63.15\% of the time. Articles which mention Federal Reserve chairman Ben Bernanke cite him saying that he plans on cutting interest rates and him warning about a looming recession.



Validating on group 4/12
Best word is: fell-or-points (12004). It classified 173/228 examples correctly.
If that word was present the stock market was more likely to go down

Best word is: rose-points (28917). It classified 159/228 examples correctly.
If that word was present the stock market was more likely to go up

Best word is: average-fell (2485). It classified 155/228 examples correctly.
If that word was present the stock market was more likely to go down

Best word is: action-stocks-rose (291). It classified 139/228 examples correctly.
If that word was present the stock market was more likely to go up

Best word is: industrials-fell (16664). It classified 162/228 examples correctly.
If that word was present the stock market was more likely to go down


From the previous results, it seems that using phrases does better than words in general. Though the 


\begin{table}[h]
\centering
\begin{tabular}{|l|}
knn (K,R) = (1,50) (1,75) (1,100) (5,50) (5,75) (5,100) (10,50) (10,75) (10,100)
...
knn (K,R) = (1,50) (1,100) (1,150) (5,50) (5,100) (5, 150) (10,50) (10,100) (10,150)
yesterday 
today       48.02  51.59   51.26    55.36  51.72   48.94   56.68 57.54 54.76
6-day-mem 
tomorrow  
\end{tabular}
\caption{This table shows some data}
