...
plot(w:n, phmmnb_ratio(w:n), 'LineWidth', lw, 'color', C{3});
axis([1 250 0.3 0.8])

plot(w:n, phmm_ratio(w:n), 'LineWidth', lw, 'color', C{2});
axis([1 250 0.3 0.8])
...
legend('pick-most-common', 'Hidden Markov Model as prior to Naive Bayes', 'Hidden Markov Model', 'Dow Jones Performance');
